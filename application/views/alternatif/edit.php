    ...
    <div class="col-md-8">
        <div class="card shadow-lg mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <?= form_open(); ?>
                <input type="text" id="id" name="id" class="form-control" value="<?= $alternatif[0]['cu_alternatif'] ?>"
                    hidden>
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="cu_alternatif" name="cu_alternatif" class="form-control"
                            value="<?= $alternatif[0]['cu_alternatif'] ?>" readonly>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="nama" name="nama" class="form-control"
                            placeholder="Nama Lengkap Karyawan" value="<?= $alternatif[0]['nama'] ?>">
                    ...
                    <div class="col-md-6">
                        <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                            ...
                            <option value='Laki-Laki'
                                <?php if($alternatif[0]['jenis_kelamin'] == "Laki-Laki"){echo "Selected";} ?>>Laki-Laki
                            </option>
                            <option value='Perempuan'
                                <?php if($alternatif[0]['jenis_kelamin'] == "Perempuan"){echo "Selected";} ?>>Perempuan
                            </option>
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control"
                            placeholder="Tempat Lahir" value="<?= $alternatif[0]['tempat_lahir'] ?>">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control"
                            placeholder="Tanggal Lahir" value="<?= $alternatif[0]['tanggal_lahir'] ?>">
                    ...
                    <div class="col-md-6">
                        <select class="form-control" id="pendidikan" name="pendidikan">
                            ...
                            <option value='SMA/SMK'
                                <?php if($alternatif[0]['pendidikan'] == "SMA/SMK"){echo "Selected";} ?>>SMA/SMK
                                Sederajat</option>
                            <option value='S1' <?php if($alternatif[0]['pendidikan'] == "S1"){echo "Selected";} ?>>S1
                            </option>
                            <option value='S2' <?php if($alternatif[0]['pendidikan'] == "S2"){echo "Selected";} ?>>S2
                            </option>
                            <option value='S3' <?php if($alternatif[0]['pendidikan'] == "S3"){echo "Selected";} ?>>S3
                            </option>
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="number" step="0.1" id="pengalaman" name="pengalaman" class="form-control"
                            placeholder="Lama Pengalaman Kerja" value="<?= $alternatif[0]['pengalaman'] ?>">
                    ...
                    <div class="col-md-6">
                        <select class="form-control" id="status_menikah" name="status_menikah">
                            ...
                            <option value='Belum Menikah'
                                <?php if($alternatif[0]['status'] == "Belum Menikah"){echo "Selected";} ?>>Belum Menikah
                            </option>
                            <option value='Menikah'
                                <?php if($alternatif[0]['status'] == "Menikah"){echo "Selected";} ?>>Sudah Menikah
                            </option>
                        </select>
