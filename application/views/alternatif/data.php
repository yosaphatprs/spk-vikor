                    ...
                    foreach ($alternatif as $dataalternatif) :
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('dataalternatif/show/') . $dataalternatif['cu_alternatif']?>" class="btn btn-sm btn-primary"><i class="fa fa-fw fa-eye"></i> Detail Informasi</a>
                            </td>
                            <td class="text-center">
                                <a href="<?= base_url('dataalternatif/edit/') . $dataalternatif['cu_alternatif'] ?>" class="btn btn-circle btn-sm btn-warning"><i class="fa fa-fw fa-edit"></i></a>
                                <a onclick="return confirm('Yakin ingin menghapus data?')" href="<?= base_url('dataalternatif/delete/') . $dataalternatif['cu_alternatif'] ?>" class="btn btn-circle btn-sm btn-danger"><i class="fa fa-fw fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach;
                    else : ?>
