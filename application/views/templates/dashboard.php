...
<head>
    ...
    <title> Aplikasi SPK Pemilihan Guru Honorer Berprestasi</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if (is_admin()) { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link pb-0" href="<?= base_url('datasubkriteria'); ?>">
                        <i class="fas fa-fw fa-cubes"></i>
                        <span class="text-light">Data SubKriteria</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link pb-0" href="<?= base_url('penilaian'); ?>">
                        ...
                        <span class="text-light">Penilaian Guru Honorer</span>
                    </a>
                </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-dark bg-info topbar mb-4 static-top shadow-sm">
                    ...
                    <div class="text-center d-none d-md-inline">
                        <a href="#" class="btn btn-info border-0" data-toggle="tooltip" title="Tutup Sidebar" id="sidebarToggle"><i class="fas fa-fw fa-server"></i></a>
                    </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= base_url() ?>assets/img/avatar/user.png ?>"><br>
                            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <strong>&copy; 2022 Penerapan Metode Vikor Dalam Pemilihan Guru Honorer Berprestasi pada SMP Pahlawan Nasional </strong>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
