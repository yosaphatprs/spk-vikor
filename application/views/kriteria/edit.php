    ...
    <div class="col-md-8">
        <div class="card shadow-lg mb-4 border-bottom-info">
            ...
            <div class="card-body pb-1">
                ...
                <?= form_open(); ?>
                <input value="<?php echo $kriteria[0]['id_kriteria']; ?>" type="text" id="id_kriteria" name="id_kriteria" class="form-control" placeholder="Kode Kriteria" hidden>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="kode">Kode Kriteria</label>
                    <div class="col-md-6">
                        <input value="<?php echo $kriteria[0]['id_kriteria']; ?>" type="text" id="kode" name="kode" class="form-control" disabled>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?php echo $kriteria[0]['nama_kriteria']; ?>" type="text" id="nama_kriteria" name="nama_kriteria" class="form-control" placeholder="Nama Kriteria">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?php echo $kriteria[0]['bobot']; ?>" type="number" step="0.01" id="bobot" name="bobot" class="form-control" placeholder="Nilai Bobot">
