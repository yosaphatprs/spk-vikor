    ...
    <div class="col-md-8">
        <div class="card shadow-lg mb-4 border-bottom-info">
            <div class="card-header bg-info py-3">
              <div class="row">
                <div class="col-auto">
                    <a href="<?= base_url('manajemenakun') ?>" class="btn btn-sm btn-secondary btn-icon-split">
        ...
        <div class="card-body pb-2">
                ...
                <?= form_open('', [], ['id_user' => $user[0]['id_user']]); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="username">Username</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('username', $user[0]['username']); ?>" type="text" id="username" name="username" class="form-control" placeholder="Username">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('nama', $user[0]['nama']); ?>" type="text" id="nama" name="nama" class="form-control" placeholder="Nama">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input <?= $user[0]['role'] == 'admin' ? 'checked' : ''; ?> <?= set_radio('role', 'admin'); ?> value="admin" type="radio" id="admin" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="admin">Admin</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= $user[0]['role'] == 'pimpinan' ? 'checked' : ''; ?> <?= set_radio('role', 'pimpinan'); ?> value="pimpinan" type="radio" id="pimpinan" name="role" class="custom-control-input">
