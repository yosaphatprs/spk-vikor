    ...
    <div class="col-md-8">
        <div class="card shadow-lg mb-4 border-bottom-info">
            ...
            <div class="card-body pb-2">
                ...
                <?= form_open(); ?>
                <input type="text" id="cu_alternatif" name="cu_alternatif" class="form-control" placeholder="Masukkan Id Alternatif" value="<?php echo $alternatif[0]['cu_alternatif'] ?>" hidden>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="nama" name="" class="form-control" placeholder="nama Alternatif" value="<?= $alternatif[0]['nama'] ?>" readonly>
                ...
                ?>
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="row form-group">
                                <div class="col">
                                <select class="form-control" id="nilaikriteria<?php echo $kodekriteria; ?>" name="nilaikriteria<?php echo $kodekriteria; ?>" required>
                                  <option>- Pilih -</option>
                                    <?php
                                    foreach ($subkriteria as $datasubkriteria) {
                                        if ($datakriteria['id_kriteria'] == $datasubkriteria['id_kriteria']) {
                                            ?>
                                        <option value='<?php echo $datasubkriteria['bobot']; ?>'><?php echo $datasubkriteria['kategori']; ?></option>
                                    <?php
                                        } }
                                    ?>
                                </select>
